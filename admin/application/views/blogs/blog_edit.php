      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('blogs/edit/'.$blog['id']), 'class="form-horizontal"' )?> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Update Blog" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close(); ?>
        </div>
