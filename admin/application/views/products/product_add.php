      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('product/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group row">
                ...
                <label for="model" class="col-sm-6 control-label">Model <span class="red">*</span></label>  
                  <input type="text" name="model" class="form-control" id="name" placeholder="" value="<?= set_value('model'); ?>">
                </div>
                <div class="col-sm-6">
              ...
              <div class="form-group row">
                ...
                <label for="special_price" class="col-sm-6 control-label">Special Price </label>  
                  <input type="text" name="special_price" class="form-control" id="sku" placeholder="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/[^\d\.]/g, '')" value="<?= set_value('special_price'); ?>">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-6">
              ...
              <div class="form-group row"> 
                ...
                <div class="col-md-6">                 
                 ...
                 <input type="file" name="image[<?php echo $image_row?>][image]" accept=".png, .jpg, .jpeg, .gif, .svg">
                ...
                <?php $image_row++; ?>
                <div class="col-md-6" style="margin-top:15px;"> <input type="button" name="addimg" value="Add Image" class="btn btn-warning addimg"> </div>
